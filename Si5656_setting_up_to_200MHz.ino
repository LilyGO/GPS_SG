...
//  check_and_write(27,0x70,0x80);
  check_and_write(28,0x37,0xFF);
  check_and_write(29,0x20,0xFF);
  check_and_write(30,0xA8,0xFF);
  ///
  ...
  i2c_write(35,0x00);
  check_and_write(36,0x03,0x1F);
  //////
  check_and_write(37,0x03,0x1F);
  check_and_write(38,0x03,0x1F);
  check_and_write(39,0x03,0x1F);
...
//
///////////////////////////////////
  check_and_write(52,0x10,0x0C);
  check_and_write(53,0x00,0xFF);
  check_and_write(54,0x6C,0xFF);
  check_and_write(55,0x3C,0xFF);
  check_and_write(56,0x00,0xFF);
  check_and_write(57,0x00,0xFF);
  check_and_write(58,0x00,0xFF);
  check_and_write(59,0x01,0xFF);
  check_and_write(60,0x00,0xFF);  
  check_and_write(61,0x00,0xFF);  
  check_and_write(62,0x00,0xFF);
  check_and_write(63,0x10,0x0C);
  check_and_write(64,0x00,0xFF);
  check_and_write(65,0x35,0xFF);
  check_and_write(66,0x00,0xFF);
  check_and_write(67,0x00,0xFF);
  check_and_write(68,0x00,0xFF);
  check_and_write(69,0x00,0xFF);
  check_and_write(70,0x01,0xFF);  
  check_and_write(71,0x00,0xFF);  
  check_and_write(72,0x00,0xFF);
  check_and_write(73,0x00,0x3F);
  check_and_write(74,0x10,0x0C);
  check_and_write(75,0x00,0xFF);
  check_and_write(76,0x09,0xFF);
  check_and_write(77,0x3C,0xFF);
  check_and_write(78,0x01,0xFF);
  check_and_write(79,0x00,0xFF);
  check_and_write(80,0x00,0xFF);  
  check_and_write(81,0x01,0xFF);  
  check_and_write(82,0x00,0xFF);
  check_and_write(83,0x00,0xFF);
  check_and_write(84,0x00,0x3F);
  check_and_write(85,0x10,0x0C);
  check_and_write(86,0x80,0xFF);
  check_and_write(87,0x03,0xFF);
  check_and_write(88,0x00,0xFF);
  check_and_write(89,0x00,0xFF);
  check_and_write(90,0x00,0xFF);  
  check_and_write(91,0x00,0xFF);  
  check_and_write(92,0x01,0xFF);
  ...
  check_and_write(110,0x40,0xC0);  
  check_and_write(111,0x00,0xFF);  
  check_and_write(112,0x00,0x7F);

  check_and_write(114,0x40,0xC0);
  ...
  check_and_write(122,0x40,0xC0); 

  check_and_write(129,0x00,0x0F);
  check_and_write(130,0x00,0x0F); 

  check_and_write(144,0x00,0x80); 
